...
The only manual change you need to make is updating the version number in the [`DESCRIPTION`](https://github.com/afsc-gap-products/GAPsurvey/blob/main/DESCRIPTION) file at the repository root. The version uses a date-based format (YYYY.MM.DD). For example: 
