...
Taxonomic classification information for the current list of
SPECIES_CODE values. This table was created by the Resource Assessment
...
(https://github.com/afsc-gap-products/gap_products). There are no legal
...
A data frame with 2718 observations on the following 3 variables.
