...
- survey:
  ...
  (character) A character string of the survey you are interested in
  reivewing. Options are those from public_data\$survey, which are "AI",
  "GOA", "EBS", "NBS", "BSS".

- species_codes:

  (numeric) A species code number of a species or species you are
  specifically interested in reviewing data from. If NA/not entered, the
  function will return data for all species caught in the haul.

- years:

  (numeric) the years you want returned in the output. If years = NA,
  script will default to the last 10 years. If you would like to see all
  years, simply choose a large range that covers all years of the survey
  (e.g., 1970:2030)

- station:

  (character) A character string of the current station name (as a grid
  cell; e.g., "264-85")

- grid_buffer:

  (numeric) GOA/AI only. The number of cells around the current station
  where you would like to see catches from. Typically, use grid_buffer =
  3.
...
#> 19    I-13 Gadus macrocephalus     Pacific cod   827   442.790   9202.058
#> 20    I-13 Gadus chalcogrammus walleye pollock   363   377.003   7834.873
#>    cpue_nokm2
#> 19  17186.707
#> 20   7543.863
#> 
#> $catch$`2016`
#>    station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 17    I-13 Gadus macrocephalus     Pacific cod   779   776.725 16690.3179
#> 18    I-13 Gadus chalcogrammus walleye pollock    37     7.043   151.3404
#>    cpue_nokm2
#> 17 16739.2032
#> 18   795.0584
#> 
#> $catch$`2017`
#>    station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 15    I-13 Gadus chalcogrammus walleye pollock   139    57.062  1303.8383
#> 16    I-13 Gadus macrocephalus     Pacific cod    13     9.800   223.9251
#>    cpue_nokm2
#> 15  3176.0808
#> 16   297.0435
#> 
#> $catch$`2018`
#>    station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 13    I-13 Gadus chalcogrammus walleye pollock    95     80.05  1685.4747
#> 14    I-13 Gadus macrocephalus     Pacific cod     8      5.05   106.3291
#>    cpue_nokm2
#> 13  2000.2511
#> 14   168.4422
#> 
#> $catch$`2019`
#>    station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 11    I-13 Gadus macrocephalus     Pacific cod   118    43.080   946.3481
#> 12    I-13 Gadus chalcogrammus walleye pollock    31     6.915   151.9034
#>    cpue_nokm2
#> 11   2592.133
#> 12    680.984
#> 
#> $catch$`2021`
#>    station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 9     I-13 Gadus chalcogrammus walleye pollock   793   550.359 11529.7821
#> 10    I-13 Gadus macrocephalus     Pacific cod    91    31.140   652.3695
#>    cpue_nokm2
#> 9    16613.01
#> 10    1906.41
#> 
#> $catch$`2022`
#>   station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 7    I-13 Gadus chalcogrammus walleye pollock   135   140.138   3252.886
#> 8    I-13 Gadus macrocephalus     Pacific cod   173   104.016   2414.421
#>   cpue_nokm2
#> 7   3133.623
#> 8   4015.679
#> 
#> $catch$`2023`
#>   station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 5    I-13 Gadus chalcogrammus walleye pollock    70    41.744    898.023
#> 6    I-13 Gadus macrocephalus     Pacific cod    31     9.190    197.701
#>   cpue_nokm2
#> 5  1505.8837
#> 6   666.8913
#> 
#> $catch$`2024`
#>   station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 3    I-13 Gadus chalcogrammus walleye pollock   353   351.285   8045.493
#> 4    I-13 Gadus macrocephalus     Pacific cod   118    48.125   1102.209
#>   cpue_nokm2
#> 3   8084.771
#> 4   2702.558
#> 
#> $catch$`2025`
#>   station     scientific_name     common_name count weight_kg cpue_kgkm2
#> 1    I-13 Gadus chalcogrammus walleye pollock    70    40.978   930.9190
#> 2    I-13 Gadus macrocephalus     Pacific cod    79    39.041   886.9152
#>   cpue_nokm2
#> 1   1590.227
#> 2   1794.685
#> 
...
#> 1 Gadus chalcogrammus walleye pollock    I-13 208.6    165.26    3578.45
#> 2 Gadus macrocephalus     Pacific cod    I-13 223.7    150.90    3242.26
#>   cpue_nokm2 Freq
#> 1    4512.37   10
#> 2    4806.98   10
#> 
...
#> 1  2015    I-13    9      31        VESTERAALEN 2015-06-04 11:36:07
#> 2  2016    I-13   12      31      ALASKA KNIGHT 2016-06-02 12:23:54
#> 3  2017    I-13    8      31      ALASKA KNIGHT 2017-06-05 15:12:37
#> 4  2018    I-13    9      31      ALASKA KNIGHT 2018-06-04 12:39:27
#> 5  2019    I-13   11      31        VESTERAALEN 2019-06-04 13:15:57
#> 6  2021    I-13    7      31      ALASKA KNIGHT 2021-06-02 12:05:29
#> 7  2022    I-13   12      31        VESTERAALEN 2022-06-01 16:20:20
#> 8  2023    I-13   16      31 NORTHWEST EXPLORER 2023-05-30 13:43:02
#> 9  2024    I-13   31      31 NORTHWEST EXPLORER 2024-06-05 15:40:19
#> 10 2025    I-13   11      31 NORTHWEST EXPLORER 2025-06-03 07:27:15
#>    latitude_dd_start longitude_dd_start bottom_temperature_c
#> 1           57.67938          -160.2449                  4.6
#> 2           57.66506          -160.2658                  6.0
#> 3           57.65211          -160.2444                  3.3
#> 4           57.68093          -160.2568                  4.3
#> 5           57.69052          -160.2580                  5.5
#> 6           57.65493          -160.2535                  4.4
#> 7           57.65502          -160.2754                  3.6
#> 8           57.66505          -160.2725                  3.4
#> 9           57.64550          -160.2743                  3.0
#> 10          57.66988          -160.2466                  4.7
#>    surface_temperature_c depth_m distance_fished_km net_width_m net_height_m
#> 1                    7.5      55              2.969      16.207        2.635
#> 2                    7.1      55              3.116      14.935        2.880
#> 3                    3.5      53              2.829      15.470        2.426
#> 4                    4.5      54              2.887      16.451        2.459
#> 5                    7.5      54              2.840      16.029        2.200
#> 6                    4.7      55              2.954      16.159        1.794
#> 7                    7.6      54              2.854      15.095        2.566
#> 8                    3.4      55              2.879      16.146        2.175
#> 9                    3.3      53              2.796      15.616        2.287
#> 10                   4.7      56              2.805      15.693        2.130
#>    area_swept_km2 duration_hr total_weight_kg
#> 1      0.04811858       0.527         3026.00
#> 2      0.04653746       0.545         4480.00
#> 3      0.04376463       0.518         1296.00
#> 4      0.04749404       0.515          875.12
#> 5      0.04552236       0.520         3186.00
#> 6      0.04773369       0.522         1220.00
#> 7      0.04308113       0.531         1190.00
#> 8      0.04648433       0.516          812.00
#> 9      0.04366234       0.511         2893.00
#> 10     0.04401886       0.504         1288.00
#> 
