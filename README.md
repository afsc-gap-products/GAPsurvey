...
#>  [1] tidyselect_1.2.1   dplyr_1.1.4        farver_2.1.2       fastmap_1.2.0      gapindex_3.0.2     xopen_1.0.1        janitor_2.2.1      akgfmaps_4.0.4     promises_1.3.2     digest_0.6.37     
#> [11] timechange_0.3.0   mime_0.13          lifecycle_1.0.4    sf_1.0-20          ellipsis_0.3.2     processx_3.8.6     terra_1.8-42       magrittr_2.0.3     compiler_4.4.3     rlang_1.1.5       
#> [21] tools_4.4.3        yaml_2.3.10        data.table_1.17.0  knitr_1.50         FNN_1.1.4.1        prettyunits_1.2.0  htmlwidgets_1.6.4  curl_6.2.2         sp_2.2-0           pkgbuild_1.4.7    
#> [31] classInt_0.4-11    xml2_1.3.8         RColorBrewer_1.1-3 pkgload_1.4.0      abind_1.4-8        KernSmooth_2.23-26 miniUI_0.1.2       withr_3.0.2        purrr_1.0.4        desc_1.4.3        
#> [41] grid_4.4.3         urlchecker_1.0.1   profvis_0.4.0      xts_0.14.1         readtext_0.91      xtable_1.8-4       e1071_1.7-16       scales_1.4.0       cli_3.6.3          rmarkdown_2.29    
#> [51] intervals_0.15.5   generics_0.1.3     remotes_2.5.0      rstudioapi_0.17.1  httr_1.4.7         sessioninfo_1.2.3  DBI_1.2.3          cachem_1.1.0       proxy_0.4-27       stringr_1.5.1     
#> [61] stars_0.6-8        parallel_4.4.3     vctrs_0.6.5        callr_3.7.6        rcmdcheck_1.4.0    testthat_3.2.3     units_0.8-7        glue_1.8.0         ps_1.9.1           codetools_0.2-20  
#> [71] gstat_2.1-3        lubridate_1.9.4    stringi_1.8.7      gtable_0.3.6       later_1.4.2        tibble_3.2.1       pillar_1.10.2      brio_1.1.5         htmltools_0.5.8.1  R6_2.6.1          
#> [81] rprojroot_2.0.4    evaluate_1.0.3     shiny_1.10.0       lattice_0.22-6     memoise_2.0.1      snakecase_0.11.1   httpuv_1.6.16      class_7.3-23       Rcpp_1.0.14        spacetime_1.3-3   
#> [91] xfun_0.52          fs_1.6.6           zoo_1.8-14         pkgconfig_2.0.3
```
