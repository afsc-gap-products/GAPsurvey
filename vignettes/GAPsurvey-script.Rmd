...
```{r get_catch_haul_history-1, eval = FALSE}
get_catch_haul_history(
...
```{r get_catch_haul_history-2, eval = FALSE}
get_catch_haul_history(
     survey = "AI",
     station = "324-73",
     grid_buffer = 3)
